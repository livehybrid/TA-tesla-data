...
class COLLECT_SUC_DATA(TeslaModInput):
    ...
    def collect_data(self, inputs, ew):
        for input_name, input_item in inputs.inputs.items():
            ...
            body = "{\"query\":\"\\n    query GetNearbyChargingSites($args: GetNearbyChargingSitesRequestType!) {\\n  charging {\\n    nearbySites(args: $args) {\\n      sitesAndDistances {\\n        ...ChargingNearbySitesFragment\\n      }\\n    }\\n  }\\n}\\n    \\n    fragment ChargingNearbySitesFragment on ChargerSiteAndDistanceType {\\n  activeOutages {\\n    message\\n    nonTeslasAffectedOnly {\\n      value\\n    }\\n  }\\n  availableStalls {\\n    value\\n  }\\n  centroid {\\n    ...EnergySvcCoordinateTypeFields\\n  }\\n  drivingDistanceMiles {\\n    value\\n  }\\n  entryPoint {\\n    ...EnergySvcCoordinateTypeFields\\n  }\\n  haversineDistanceMiles {\\n    value\\n  }\\n  id {\\n    text\\n  }\\n  localizedSiteName {\\n    value\\n  }\\n  maxPowerKw {\\n    value\\n  }\\n  totalStalls {\\n    value\\n  }\\n  siteType\\n  accessType\\n}\\n    \\n    fragment EnergySvcCoordinateTypeFields on EnergySvcCoordinateType {\\n  latitude\\n  longitude\\n}\\n    \",\"variables\":{\"args\":{\"userLocation\":{\"latitude\":"+user_lat_long[0]+",\"longitude\":"+user_lat_long[1]+"},\"northwestCorner\":{\"latitude\":"+northwest_lat_long[0]+",\"longitude\":"+northwest_lat_long[1]+"},\"southeastCorner\":{\"latitude\":"+southeast_lat_long[0]+",\"longitude\":"+southeast_lat_long[1]+"},\"openToNonTeslasFilter\":{\"value\":false},\"languageCode\":\"en\",\"countryCode\":\"GB\",\"vin\":\"5YJ3F7EBXKF439354\"}},\"operationName\":\"GetNearbyChargingSites\"}"
            resp = requests.post(
                url,
                data=body,
                headers = headers,
#                proxies={"http":"http://192.168.0.126:8888","https":"http://192.168.0.126:8888"},
#                verify=False
            )
